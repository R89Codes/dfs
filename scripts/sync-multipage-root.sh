...
perl -0pi -e 's/href="styles\.css"/href="guide-styles.css"/g; s/src="data\.js"/src="guide-data.js"/g; s/src="app\.js"/src="guide-app.js"/g; s/href="index\.html"/href="guide.html"/g;' \
  "$ROOT_DIR/guide.html" \
  "$ROOT_DIR/dfs.html" \
  "$ROOT_DIR/topo.html" \
  "$ROOT_DIR/cycle.html"
